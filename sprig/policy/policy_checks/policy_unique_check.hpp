...
=============================================================================*/
#ifndef SPRIG_POLICY_POLICY_CHECKS_POLICY_UNIQUE_CHECK_HPP
#define SPRIG_POLICY_POLICY_CHECKS_POLICY_UNIQUE_CHECK_HPP
...
namespace sprig {
	...
	>
	struct policy_unique_check_result
	...
	struct policy_unique_check {
		...
		typedef policy_unique_check_result<
			Tag,
			Types,
			indexes,
			founds,
...
#endif	// #ifndef SPRIG_POLICY_POLICY_CHECKS_POLICY_UNIQUE_CHECK_HPP
